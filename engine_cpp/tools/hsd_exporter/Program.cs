...
static void WriteFighterAttributesBinary(BinaryWriter writer, SBM_CommonFighterAttributes? attr)
{
    ...
    writer.Write(attr._s.GetFloat(0x100));
    writer.Write(attr.WallJumpHorizontalVelocity);
    writer.Write(attr.WallJumpVerticalVelocity);
    writer.Write(attr._s.GetFloat(0x10C));
    writer.Write(attr.LedgeJumpHorizontalVelocity);
    writer.Write(attr.LedgeJumpVerticalVelocity);
    writer.Write((int)attr.WeightIndependentThrows);
    writer.Write(attr._s.GetFloat(0x140));
    writer.Write(attr._s.GetFloat(0x158));
    writer.Write(attr._s.GetFloat(0x15C));
    writer.Write(attr._s.GetInt32(0x98));
}
...
static void WriteCommonDataBinary(string outputPath, string commonDatPath)
{
    ...
    writer.Write(F(0x444));
    writer.Write(F(0x448));
    ...
    writer.Write(F(0x218));
    writer.Write(F(0x21C));
    writer.Write(F(0x220));
    writer.Write(F(0x224));
    ...
    writer.Write(I(0x488));
    writer.Write(R(0x48C));
    writer.Write(R(0x490));
    writer.Write(F(0x7F8));
    writer.Write(F(0x7FC));
    writer.Write(F(0x7F4));
    writer.Write(I(0x428));
    writer.Write(F(0x308));
    writer.Write(F(0x1C8));
    writer.Write(F(0x624));
    writer.Write(F(0x628));
    writer.Write(F(0x62C));
    writer.Write(F(0x630));
    writer.Write(F(0x634));
    writer.Write(F(0x638));
    writer.Write(F(0x63C));
    writer.Write(F(0x640));
    writer.Write(F(0x644));
    writer.Write(F(0x658));
    writer.Write(F(0x65C));
    writer.Write(F(0x660));
    writer.Write(F(0x664));
    writer.Write(F(0x668));
    writer.Write(F(0x66C));
    writer.Write(F(0x670));
    writer.Write(F(0x674));
    writer.Write(I(0x5F4));
    writer.Write(F(0x5F8));
    writer.Write(F(0x5FC));
    writer.Write(F(0x600));
    writer.Write(F(0x604));
    writer.Write(F(0x608));
    writer.Write(F(0x60C));
    writer.Write(F(0x610));
    writer.Write(F(0x614));
    writer.Write(F(0x618));
    writer.Write(F(0x61C));
    writer.Write(I(0x620));
    writer.Write(F(0x3D0));
    writer.Write(F(0x3D4));
    writer.Write(F(0x3D8));
    writer.Write(F(0x3DC));
    writer.Write(F(0x2F8));
    writer.Write(F(0x2FC));
    writer.Write(F(0x300));
    writer.Write(F(0x304));
    writer.Write(F(0x280));
    writer.Write(I(0x1C));
    writer.Write(F(0x164));
    writer.Write(F(0x25C));
    writer.Write(F(0x800));
    writer.Write(F(0x77C));
    writer.Write(F(0x790));
    writer.Write(F(0x794));
    writer.Write(F(0x798));
    writer.Write(F(0x79C));
    writer.Write(F(0x7A4));
}
