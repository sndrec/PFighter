...
struct FighterRuntime {
    ...
    AnimationPose animationBlendFromPose;
    int animationBlendFrames = 0;
    Fix animationBlendElapsed = 0;
    Vec3 animationTransN = {};
    Vec3 previousAnimationTransN = {};
    Vec3 animationTransNOffset = {};
    std::vector<JointWorldTransform> jointWorldTransforms;
    std::vector<Vec3> jointWorldPositions;
    std::vector<Capsule> poseHurtboxCapsules;
    std::vector<int> modelVisibilityDefaultStates;
    std::vector<int> modelVisibilityStates;
    std::vector<int> modelPartAnimations;
