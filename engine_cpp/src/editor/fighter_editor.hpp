...
struct FighterEditor {
    ...
    std::vector<int> selectedSubactions;
    ...
    int stateLogicTab = 0;
    int stateLogicCallbackScroll = 0;
    int stateLogicInterruptScroll = 0;
    ...
    bool timelineBoxSelectArmed = false;
    bool timelineBoxSelecting = false;
    bool timelineGrabActive = false;
    bool timelineGrabCancel = false;
    float timelineDragStartMouseX = 0.0f;
    float timelineDragStartMouseY = 0.0f;
    float timelineDragMouseX = 0.0f;
    float timelineDragMouseY = 0.0f;
    std::vector<int> timelineGrabSubactions;
    std::vector<int> timelineGrabStartFrames;
    bool timelineStackPickerOpen = false;
    int timelineStackPickerFrame = -1;
